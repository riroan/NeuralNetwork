...
Convolution2D::Convolution2D(const int& _row, const int& _col, const int& _stride, const int& f_w, const int& f_h, const int& _padding, const int& _layer_act, const char * _pad_type)
	:input(_row, _col), padding(_padding), stride(_stride), filter(f_h, f_w), learning_rate(0.1), gradient(_row, _col)
{
